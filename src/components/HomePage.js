        ...
        <div className="homepage">
          ...
          <div className="home-row">
            <div className="dashboard-item">
              ...
              <p>
                {connected ? new Intl.NumberFormat().format(holders) : <span>N/A</span>}
              </p>
            ...
            <div className="dashboard-item">
              ...
              <p>{connected ? staked : <span>N/A</span>}</p>
              <svg width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="home-row">
            <div className="dashboard-item">
              ...
              <p>{connected ? earlyRemoved : <span>N/A</span>}</p>
            ...
            <div className="dashboard-item">
              ...
              <p>{connected ? new Intl.NumberFormat().format(parseFloat(ethers.utils.formatEther(totalDusty))) : <span>N/A</span>}</p>
              <svg width="80" height="80" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="home-row">
            <div className="dashboard-item">
              ...
              <p>{connected ? new Intl.NumberFormat().format(totalSupply) : <span>N/A</span>}</p>
            </div>
            <div className="dashboard-item">
              <h2>Total $Dusty locked</h2>
              <p>{connected ? new Intl.NumberFormat().format(10000000 - totalSupply) : <span>N/A</span>}</p>
            </div>
          </div>
        </div>
      </Container>
